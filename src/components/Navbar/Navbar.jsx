...
const Navbar = () => {
    ...
    return (
        <nav className="flex flex-wrap justify-between md:items-center text-white mx-10 pt-6 md:px-20">
            <span className="text-2xl font-bold tracking-tight">PortFolio</span>
            <ul className={`
       ${menu ? "block" : "hidden"}
       mx-24 py-2 mt-4 fonnt-bold md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-no
